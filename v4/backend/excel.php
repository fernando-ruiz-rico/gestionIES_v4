...
escribirCursosYMaterias($escenario, $objExcel, $bd);
$fila = profesoresPorTipo($escenario, $objExcel, $bd);
$fila = horasPorGrupo($escenario, $objExcel, $bd, $fila);
$fila = horasPorProfesor($escenario, $objExcel, $bd, $fila);
nombresProfesores($escenario, $objExcel, $bd, $fila);
$bd->close();
