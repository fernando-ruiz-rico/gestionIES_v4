...
{
    fetch("ajax/programaciones_apartados/cargar_apartado.php?" + new URLSearchParams(idApartado:id)).then(response => response.text()).then(res => {
...
function nuevoApartado()
{
    ...
    document.getElementById('formapartadoprogramacion').show();
}
