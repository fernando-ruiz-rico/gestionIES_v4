...
const MateriasView = {
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="m in materias" :key="m.idMateria">
                                        <td>{{ m.idMateria }}</td>
                                        <td>{{ m.nombre }}</td>
                                        <td class="text-end">
                                            ...
                                            <button class="btn btn-sm btn-outline-danger" @click="eliminar(m)">
    ...
    methods: {
        async cargar() {
            const result = await MateriasAPI.listar();
            if (result.success) {
