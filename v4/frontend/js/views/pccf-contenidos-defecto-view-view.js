const pccf-contenidos-defecto-viewView = {
    template: `
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="mb-0"><i class="bi bi-file-text me-2"></i>Contenidos por Defecto PCCF</h2>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{ editando ? 'Editar' : 'Nuevo' }} Contenidos por Defecto PCCF</h5>
    ...
    methods: {
        ...
        guardar() {
            pccfContenidosDefecto.guardar(this.formulario)
                .then(response => {
                    if (response.success) {
        ...
        eliminar(item) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    pccfContenidosDefecto.eliminar(item.id)
                        .then(response => {
                            if (response.success) {
