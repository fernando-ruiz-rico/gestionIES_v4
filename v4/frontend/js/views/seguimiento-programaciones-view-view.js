const seguimiento-programaciones-viewView = {
    template: `
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="mb-0"><i class="bi bi-file-text me-2"></i>Seguimiento de Programaciones</h2>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{ editando ? 'Editar' : 'Nuevo' }} Seguimiento de Programaciones</h5>
    ...
    methods: {
        cargar() {
            this.cargando = true;
            this.error = null;
            seguimientoProgramaciones.listar()
                .then(response => {
                    if (response.success) {
        ...
        guardar() {
            seguimientoProgramaciones.guardar(this.formulario)
                .then(response => {
                    if (response.success) {
        ...
        eliminar(item) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    seguimientoProgramaciones.eliminar(item.id)
                        .then(response => {
                            if (response.success) {
