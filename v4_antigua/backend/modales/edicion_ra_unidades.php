    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- El id "formres_ra" se usa para enviar el formulario por JavaScript -->
...
<script type="text/javascript">
    ...
    dom('#esClave').on('change', function() {
        const label = dom('#descripcionEsClave');
        if (this.checked) {
    ...
    dom("#formres_ra").on("submit", function(e)
    {
        e.preventDefault();
        ...
        .done(function(res){
            dom("#formresultado_ra").modal('hide');
