...
if (!empty($_REQUEST['idDepartamento']))
{
    ...
    echo '<div class="card-header"><h2><a class="card-link-title collapsed" data-bs-toggle="collapse" href="#ciclos">Ciclos formativos </a></h2></div>';
    ...
    foreach($ciclos as $ciclo)
    {
        ...
        echo '<div class="card-header"><h3 class="mt-2"><a class="card-link-title collapsed" data-bs-toggle="collapse" href="#ciclo' . $ciclo['id'] . '">' . $ciclo['nombre'] . ' </a></h3></div>';
        ...
        foreach($cursos as $curso)
        {
            ...
            {
                echo '<li><a href="pdf_programaciones.php?idMateria=' . $materia['id'] . '">' . $materia['nombre'] . '</a></li>';
            }
            echo "</ul></div>";
        }
    ...
    echo '<div class="row my-4"><div class="col-md-12"><div class="card">';
    echo '<div class="card-header"><h2><a class="card-link-title collapsed" data-bs-toggle="collapse" href="#pccfs">Proyectos Curriculares de Ciclos Formativos </a></h2></div>';
    ...
    foreach($ciclos as $ciclo)
    {
        echo '<li><a href="pdf_pccf.php?idCiclo=' . $ciclo['id'] . '">' . $ciclo['nombre'] . '</a></li>';
    }
    echo "</ul></div>";
    ...
    echo '<div class="row my-4"><div class="col-md-12"><div class="card">';
    echo '<div class="card-header"><h2><a class="card-link-title collapsed" data-bs-toggle="collapse" href="#otros">Otros estudios (ESO, Bachillerato) </a></h2></div>';
    ...
    foreach($materias as $materia)
    {
        ...
        echo '<li><a href="pdf_programaciones.php?idMateria=' . $materia['id'] . '">' . $materia['nom_curso'] . ': ' . $materia['nom_materia'] . '</a></li>';
    }
    echo "</ul></div>";
    ...
    foreach($materias as $materia)
    {
        ...
        foreach($profesores as $profesor)
        {
            ...
            foreach($grupos as $grupo)
            {
                ...
                echo "<li><a href='pdf_programaciones_aula.php?idMateria={$materia['id']}&idGrupo={$grupo['id']}&idProfesor={$profesor['id']}'>{$materia['nom_curso']}: {$materia['nom_materia']} ({$profesor['nombre']} - {$grupo['nombre']})</a></li>";
            }
        }
    }
    echo "</ul></div>";
